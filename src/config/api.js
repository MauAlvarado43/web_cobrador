...
const getEntriesEgress = async (SSID, sucursal) => {
...
const getSucursals = async (SSID) => {
     
    let session = JSON.parse(decryptSession(SSID))

    let response = await fetch(URL + '/getSucursals', {
        method: 'POST',
        mode: 'cors',
        cache: 'no-cache',
        credentials: 'same-origin',
...
const getPaymentsSucursal = async (SSID, name) => {
...
const generateReportLendings = async (SSID, save, lapse, name) => {
...
const getAccountStatus = async (SSID, lapse, name) => {
...
const registerEmployee = async (SSID, name, app, apm, rfc, type, suc) => {
...
const registerSucursal = async (SSID, name, dom) => {

    let session = JSON.parse(decryptSession(SSID))

    let response = await fetch(URL + '/registerSucursal', {
        method: 'POST',
        mode: 'cors',
        cache: 'no-cache',
        credentials: 'same-origin',
...
export { loginUser, getClients, updatePassword, registerEmployee, registerSucursal, getAssigned, getClientsWithRennovation, randomAssigned, getClientLendingRennovation, responseRennovation, getActiveLendings, getClientLending, registerClient, getClient, requestLending, getPayments, requestPayment, getSucursalTotal, registerEntry, registerEgress, getClientsWithLendingRevision, getClientRevision, responseLending, getEntriesEgress, getPaymentsSucursal, generateReportLendings, getReportsName, getReport, downloadReport, deleteReport, getSucursals, getAccountStatus, requestIncreaseDate }