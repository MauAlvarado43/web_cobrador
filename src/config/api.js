...
export { loginUser, getClients, getActiveLendings, registerClient, getClient, requestLending, getPayments, requestPayment, getSucursalTotal, registerEntry, registerEgress, getClientsWithLendingRevision, getClientRevision, responseLending, getEntriesEgress, getPaymentsSucursal, generateReportLendings, getReportsName, getReport, downloadReport, deleteReport, getAccountStatus }